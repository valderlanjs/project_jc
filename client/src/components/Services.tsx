...
import { TreePine, Package, Truck, Shield, Star, ArrowRight } from "lucide-react";

const services = [
  {
    icon: TreePine,
    title: "Madeiras Nobres",
    description: "Seleção premium de madeiras certificadas com garantia de origem sustentável.",
    features: ["Certificação FSC", "Origem sustentável", "Qualidade superior"]
  },
  {
    icon: Package,
    title: "Corte Personalizado",
    description: "Serviço de corte sob medida para atender suas especificações exatas.",
    features: ["Precisão milimétrica", "Diversos formatos", "Acabamento perfeito"]
  },
  {
    icon: Truck,
...
export const Services = () => {
  return (
    <section id="servicos" className="py-24 px-4 relative overflow-hidden bg-gradient-to-br from-background to-gray-50/50">
      {/* Background Elements */}
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-primary/10 backdrop-blur-sm border border-primary/20 rounded-full px-6 py-3 mb-6">
            ...
            <span className="text-sm font-semibold text-primary">Serviços Exclusivos</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Soluções completas em madeira com atendimento especializado e qualidade garantida 
          ...
          <div className="inline-flex flex-col sm:flex-row items-center gap-6 bg-white/50 backdrop-blur-sm border border-gray-200/50 rounded-2xl px-8 py-6 max-w-4xl mx-auto">
            <div className="text-left flex-1">
              ...
              <p className="text-muted-foreground text-lg">
                Nossa equipe de especialistas está pronta para desenvolver a solução perfeita para seu projeto.
              </p>
            </div>
            <button className="
              bg-primary
